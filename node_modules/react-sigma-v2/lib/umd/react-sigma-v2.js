(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("graphology"), require("react"), require("sigma"));
	else if(typeof define === 'function' && define.amd)
		define(["graphology", "react", "sigma"], factory);
	else if(typeof exports === 'object')
		exports["react-sigma-v2"] = factory(require("graphology"), require("react"), require("sigma"));
	else
		root["react-sigma-v2"] = factory(root["graphology"], root["react"], root["sigma"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE__5__, __WEBPACK_EXTERNAL_MODULE__3__, __WEBPACK_EXTERNAL_MODULE__4__) {
...
const tslib_1 = __webpack_require__(1);
const react_1 = tslib_1.__importStar(__webpack_require__(3));
const sigma_1 = __webpack_require__(4);
const graphology_1 = tslib_1.__importDefault(__webpack_require__(5));
const context_1 = __webpack_require__(6);
...
const SigmaContainer = ({ graphOptions, id, className, style, initialSettings, children, }) => {
    ...
    const settings = react_1.useRef();
    if (!lodash_1.isEqual(settings.current, initialSettings))
        settings.current = initialSettings;
    const graph = react_1.useRef();
    if (!lodash_1.isEqual(graph.current, graphOptions))
    ...
    const context = react_1.useMemo(() => (sigma && rootRef.current ? { sigma, container: rootRef.current } : null), [sigma, rootRef.current]);
...
const react_1 = __webpack_require__(3);
const useSigma_1 = __webpack_require__(8);
const useSetSettings_1 = __webpack_require__(10);
const sigmaEvents = [
    "clickNode",
    "rightClickNode",
    "downNode",
...
const tslib_1 = __webpack_require__(1);
const react_1 = tslib_1.__importDefault(__webpack_require__(3));
...
const tslib_1 = __webpack_require__(1);
const react_1 = tslib_1.__importStar(__webpack_require__(3));
const worker_1 = tslib_1.__importDefault(__webpack_require__(14));
const lodash_1 = __webpack_require__(7);
const useSigma_1 = __webpack_require__(8);
 ...
 */
var workerFunction = __webpack_require__(15),
    isGraph = __webpack_require__(16),
    helpers = __webpack_require__(17);

var DEFAULT_SETTINGS = __webpack_require__(18);
...
const ZoomControl = ({ className, style, animationDuration = 200, customZoomIn, customZoomOut, customZoomCenter, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", Object.assign({}, props, { className: `react-sigma-control-zoom-in ${className ? className : ""}` }),
            react_1.default.createElement("button", { className: customZoomIn ? "" : "default", onClick: () => zoom(1), title: "Zoom In" }, customZoomIn)),
        react_1.default.createElement("div", Object.assign({}, props, { className: `react-sigma-control-zoom-out ${className ? className : ""}` }),
            react_1.default.createElement("button", { className: customZoomOut ? "" : "default", onClick: () => zoom(-1), title: "Zoom Out" }, customZoomOut)),
        react_1.default.createElement("div", Object.assign({}, props, { className: `react-sigma-control-zoom-center ${className ? className : ""}` }),
            react_1.default.createElement("button", { className: customZoomCenter ? "" : "default", onClick: () => zoom(), title: "See whole graph" }, customZoomCenter))));
};
